...
while True:
        ...
        # 生成保存路径
        main_path = "C:/Users/15201/Desktop/test/"
        pic_name1 = f"image_{current_time}1.jpg"
        pic_name2 = f"image_{current_time}2.jpg"
        save_path1 = main_path + pic_name1
        save_path2 = main_path + pic_name2
        # 拍照并保存图片
        capture_image(camera0, save_path1)
        capture_image(camera1, save_path2)
        i=i+1
        # 等待一段时间
        time.sleep(interval)
...
OPENMVG_BIN=R"bin\MVG"
OPENMVS_BIN=R"bin\MVS"
CAMERA_SENSOR_DB_DIRECTORY="bin"
    ...
    def __init__(self):
        self.steps_data = [
            ["Intrinsics analysis",          # 0
             ...
             ["-i", "%input_dir%", "-o", "%matches_dir%", "-d", "%camera_file_params%", "-k","3408;0;3114;0;3408;2065;0;0;1"]],
            ["Compute features",             # 1
